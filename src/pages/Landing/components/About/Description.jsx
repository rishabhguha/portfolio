	...
	return (
		<Box sx={{
			...
			<Typography variant="body1" color={Consts.PALETTE.primary} textAlign="justify">
				Hey there! I am Rishabh, a software developer based out of <Typography variant="body1" color={Consts.PALETTE.highlight} display="inline">New York City, NY</Typography>. I am currently a Master's student at NYU Tandon School of Engieering, pursuing my major in Computer Engineering. 
			</Typography>
			<Typography variant="body1" color={Consts.PALETTE.primary} textAlign="justify">
